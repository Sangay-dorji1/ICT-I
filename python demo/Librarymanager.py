...
search_title = input("Enter the search_title in books_list: ")
if search_title in books_list:
    print(f"Book found! The Author of the book {search_title} is {books_dict[search_title]}")
else:
    print("Book not found!")

remove_title = input("Enetr the title of the book to remove or else enter to skip: ")
if remove_title in books_list:
    ...
    print("Books available along with their author: ", books_dict)
    print("Just avaiilable books: ", books_list)
